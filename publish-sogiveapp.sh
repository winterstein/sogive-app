...
if [ ! -d /home/$USER/winterwell/sogive-app/tests/screenshots/node_modules ]; then
	cd /home/$USER/winterwell/sogive-app/tests/screenshots/ && npm i
	cd /home/$USER/winterwell/sogive-app/tests/screenshots/ && bash compile.sh
fi
