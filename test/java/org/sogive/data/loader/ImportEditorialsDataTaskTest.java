...
public class ImportEditorialsDataTaskTest {
	...
	public void testImportEditorials_singleCharity_alreadyPublishedInDatabase() {
		...
		fakeDocumentFetcher.setDocumentAtUrl(generateDocumentContainingCharityEditorials(TEST_URL,
	...
	public void testImportEditorials_multipleCharities_alreadyInDatabase() {
		...
		fakeDocumentFetcher.setDocumentAtUrl(generateDocumentContainingCharityEditorials(TEST_URL,
				ImmutableMap.of("charity-one", Collections.singletonList("Charity One Editorial"), "charity-two",
						Arrays.asList("Charity Two Editorial", "Second paragraph"))));
	...
	private static Document generateDocumentContainingCharityEditorials(String baseUri,
			Map<String, List<String>> charityEditorials) {
